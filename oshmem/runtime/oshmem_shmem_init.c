...
int oshmem_shmem_init(int argc, char **argv, int requested, int *provided)
{
    ...
    if (!oshmem_shmem_initialized) {
        ...
        do {
            ...
            char *ptr = NULL;
            int n = snprintf(ename, OPAL_TIMING_STR_LEN, "OMPI_TIMING_%s_%s_CNT", "regular_mem", "mca_memheap_base_alloc_init");
        ...
        OMPI_TIMING_IMPORT_OPAL_PREFIX("exec_1", "segment_create_internal");
